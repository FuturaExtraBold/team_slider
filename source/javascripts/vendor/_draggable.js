...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    ...
    window._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(t, e, i, s) {
        ...
        , m = l.calculateTweenDuration = function(t, r, n, a, o) {
            ...
            null == o && (o = 1),
            t.length && (t = t[0] || t);
            var h, p, _, m, g, v, y, w, x, T, b = 0, P = 9999999999, k = r.throwProps || r, S = r.ease instanceof i ? r.ease : r.ease ? new i(r.ease) : e.defaultEase, C = isNaN(k.checkpoint) ? .05 : Number(k.checkpoint), R = isNaN(k.resistance) ? l.defaultResistance : Number(k.resistance);
            for (h in k)
                "resistance" !== h && "checkpoint" !== h && "preventOvershoot" !== h && (p = k[h],
                "object" != typeof p && (x = x || s.getByTarget(t),
                x && x.isTrackingProp(h) ? p = "number" == typeof p ? {
                    velocity: p
                } : {
                    velocity: x.getVelocity(h)
                } : (m = Number(p) || 0,
                _ = m * R > 0 ? m / R : m / -R)),
                "object" == typeof p && (void 0 !== p.velocity && "number" == typeof p.velocity ? m = Number(p.velocity) || 0 : (x = x || s.getByTarget(t),
                m = x && x.isTrackingProp(h) ? x.getVelocity(h) : 0),
                g = isNaN(p.resistance) ? R : Number(p.resistance),
                _ = m * g > 0 ? m / g : m / -g,
                v = "function" == typeof t[h] ? t[h.indexOf("set") || "function" != typeof t["get" + h.substr(3)] ? h : "get" + h.substr(3)]() : t[h] || 0,
                y = v + f(m, S, _, C),
                void 0 !== p.end && (p = c(p, y, p.max, p.min)),
                void 0 !== p.max && y > Number(p.max) + u ? (T = p.unitFactor || 1,
                w = v > p.max && p.min !== p.max || m * T > -15 && 45 > m * T ? a + .1 * (n - a) : d(v, p.max, m, S, C),
                P > w + o && (P = w + o)) : void 0 !== p.min && Number(p.min) - u > y && (T = p.unitFactor || 1,
                w = p.min > v && p.min !== p.max || m * T > -45 && 15 > m * T ? a + .1 * (n - a) : d(v, p.min, m, S, C),
                P > w + o && (P = w + o)),
                w > b && (b = w)),
                _ > b && (b = _));
            return b > P && (b = P),
        ...
        l._cssRegister = function() {
            ...
            if (t) {
                ...
                e._registerComplexSpecialProp("throwProps", {
                    parser: function(t, e, h, u, _, c) {
                        c = new l;
                        var f, d, m, g, v, y = {}, w = {}, x = {}, T = {}, b = {}, P = {};
                        n = {};
                        for (m in e)
                            "resistance" !== m && "preventOvershoot" !== m && (d = e[m],
                            "object" == typeof d ? (void 0 !== d.velocity && "number" == typeof d.velocity ? y[m] = Number(d.velocity) || 0 : (v = v || s.getByTarget(t),
                            y[m] = v && v.isTrackingProp(m) ? v.getVelocity(m) : 0),
                            void 0 !== d.end && (T[m] = d.end),
                            void 0 !== d.min && (w[m] = d.min),
                            void 0 !== d.max && (x[m] = d.max),
                            d.preventOvershoot && (P[m] = !0),
                            void 0 !== d.resistance && (f = !0,
                            b[m] = d.resistance)) : "number" == typeof d ? y[m] = d : (v = v || s.getByTarget(t),
                            y[m] = v && v.isTrackingProp(m) ? v.getVelocity(m) : d || 0),
                        ...
                        return null != e.resistance && (n.resistance = e.resistance),
        ...
        l.to = function(t, i, s, l, h) {
            ...
            u.vars.css ? (u.duration(m(r, {
                throwProps: n,
                ease: i.ease
            }, s, l, h)),
            u._delay && !u.vars.immediateRender ? u.invalidate() : a._onInitTween(r, o, u),
            u) : (u.kill(),
            new e(t,m(t, i, s, l, h),i))
        }
        ,
        g._onInitTween = function(t, e, i) {
            ...
            a = this,
            o = e;
            var r, n, l, h, u, p, _, d, m, g = i._ease, v = isNaN(e.checkpoint) ? .05 : Number(e.checkpoint), y = i._duration, w = e.preventOvershoot, x = 0;
            for (r in e)
                if ("resistance" !== r && "checkpoint" !== r && "preventOvershoot" !== r) {
                    ...
                    "number" == typeof n)
                        ...
                        if (m = m || s.getByTarget(t),
                        !m || !m.isTrackingProp(r))
                    ...
                    "object" == typeof n && (_ = l + p,
                    void 0 !== n.end && (n = c(n, _, n.max, n.min)),
                    void 0 !== n.max && _ > Number(n.max) ? w || n.preventOvershoot ? p = n.max - l : d = n.max - l - p : void 0 !== n.min && Number(n.min) > _ && (w || n.preventOvershoot ? p = n.min - l : d = n.min - l - p)),
                    this._props[x++] = {
                        p: r,
                        s: l,
                        c1: p,
    ...
    window._gsDefine("utils.VelocityTracker", ["TweenLite"], function(t) {
        ...
        , h = function(t, e, i) {
            ...
            return s || 0 === s ? s : (t.style[e] ? s = t.style[e] : (i = i || l(t, null)) ? (t = i.getPropertyValue(e.replace(n, "-$1").toLowerCase()),
            ...
            if (a - s >= .03)
                ...
                s = a; n; ) {
                    for (i = n._firstVP; i; )
                        t = i.css ? h(n.target, i.p) : i.f ? n.target[i.p]() : n.target[i.p],
                        (t !== i.v1 || a - i.t1 > .15) && (i.v2 = i.v1,
                        i.v1 = t,
                        i.t2 = i.t1,
                        i.t1 = a),
                        i = i._next;
            ...
            i || (u.addEventListener("tick", _, null, !1, -100),
            s = r = u.time,
            i = !0),
            e && (this._next = e,
            e._prev = this),
        ...
        return d.addProp = function(e, i) {
            if (!this._lookup[e]) {
                var s = this.target
                  ...
                  , a = this._firstVP;
                this._firstVP = this._lookup[e] = this._lookup[n] = a = new p(n !== e && 0 === e.indexOf("set") ? n : e,r,a),
                a.css = this.elem && (void 0 !== this.target.style[a.p] || o[a.p]),
                a.css && o[a.p] && !s._gsTransform && t.set(s, {
                    x: "+=0"
                }),
                a.type = i || a.css && 0 === e.indexOf("rotation") ? "deg" : "",
                a.v1 = a.v2 = a.css ? h(s, a.p) : r ? s[a.p]() : s[a.p]
            }
        }
        ,
        ...
        d.getVelocity = function(t) {
            ...
            return e = r.css ? h(n, r.p) : r.f ? n[r.p]() : n[r.p],
            i = e - r.v2,
            ("rad" === r.type || "deg" === r.type) && (s = "rad" === r.type ? 2 * Math.PI : 360,
            i %= s,
            i !== i % (s / 2) && (i = 0 > i ? i + s : i - s)),
            i / (u.time - r.t2)
        }
        ,
        ...
        c.getByTarget = function(i) {
            var s = e;
            for ("string" == typeof i && (i = t.selector(i)),
            i.length && i !== window && i[0] && i[0].style && !i.nodeType && (i = i[0]); s; ) {
                if (s.target === i)
                    return s;
                s = s._next
            }
        ...
        c.untrack = function(t, i) {
            ...
            if (s) {
                for (; --n > -1; )
                    s.removeProp(r[n]);
                s._firstVP && i || (s._prev ? s._prev._next = s._next : s === e && (e = s._next),
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(t, e, i) {
        var r, s, n, a, o, l, h, u, _ = {
            ...
            css: {}
        }, d = _gsScope._gsDefine.globals, m = {}, g = document, v = g.documentElement || {}, y = function(t) {
            return g.createElementNS ? g.createElementNS("http://www.w3.org/1999/xhtml", t) : g.createElement(t)
        }, T = y("div"), x = [], w = function() {
            return !1
        }, b = 180 / Math.PI, P = 999999999999999, S = Date.now || function() {
            return (new Date).getTime()
        }
        , k = !(g.addEventListener || !g.all), C = g.createElement("div"), R = [], O = {}, A = 0, D = /^(?:a|input|textarea|button|select)$/i, M = 0, L = -1 !== navigator.userAgent.toLowerCase().indexOf("android"), N = 0, E = {}, I = {}, z = function(t) {
            if ("string" == typeof t && (t = e.selector(t)),
            !t || t.nodeType)
                return [t];
            var i, r = [], s = t.length;
            ...
            R.push(t),
            1 === R.length && e.ticker.addEventListener("tick", F, this, !1, 1)
        }, B = function(t) {
            ...
            Me(t, "scroll", e),
            q(t.parentNode) || V(t.parentNode, e)
        }, G = function(t, e) {
            Le(t, "scroll", e),
            q(t.parentNode) || G(t.parentNode, e)
        }, q = function(t) {
            ...
            var i = "x" === e ? "Width" : "Height"
              ...
              , s = "client" + i
              , n = g.body;
            return Math.max(0, q(t) ? Math.max(v[r], n[r]) - (window["inner" + i] || v[s] || n[s]) : t[r] - t[s])
        }, Q = function(t) {
            var e = q(t)
              , i = H(t, "x")
              , r = H(t, "y");
            e ? t = I : Q(t.parentNode),
            t._gsMaxScrollX = i,
            t._gsMaxScrollY = r,
            ...
            if (void 0 === a[e]) {
                ...
                s = 5,
                i = e.charAt(0).toUpperCase() + e.substr(1); --s > -1 && void 0 === a[n[s] + i]; )
                    ;
                if (0 > s)
                    return "";
                r = 3 === s ? "ms" : n[s],
            ...
            var r = t.style;
            r && (void 0 === r[e] && (e = K(t, e)),
            null == i ? r.removeProperty ? r.removeProperty(e.replace(/([A-Z])/g, "-$1").toLowerCase()) : r.removeAttribute(e) : void 0 !== r[e] && (r[e] = i))
        }, te = g.defaultView ? g.defaultView.getComputedStyle : w, ee = /(?:Left|Right|Width)/i, ie = /(?:\d|\-|\+|=|#|\.)*/g, re = function(t, e, i, r, s) {
            if ("px" === r || !r)
                return i;
            if ("auto" === r || !i)
                return 0;
            var n, a = ee.test(e), o = t, l = T.style, h = 0 > i;
            return h && (i = -i),
            "%" === r && -1 !== e.indexOf("border") ? n = i / 100 * (a ? t.clientWidth : t.clientHeight) : (l.cssText = "border:0 solid red;position:" + ne(t, "position", !0) + ";line-height:0;",
            "%" !== r && o.appendChild ? l[a ? "borderLeftWidth" : "borderTopWidth"] = i + r : (o = t.parentNode || g.body,
            ...
            if ("absolute" !== ne(t, "position", !0))
                return 0;
            var i = "left" === e ? "Left" : "Top"
              , r = ne(t, "margin" + i, !0);
            return t["offset" + i] - (re(t, e, parseFloat(r), (r + "").replace(ie, "")) || 0)
        }, ne = function(t, e, i) {
            var r, s = (t._gsTransform || {})[e];
            return s || 0 === s ? s : (t.style[e] ? s = t.style[e] : (r = te(t)) ? (s = r.getPropertyValue(e.replace(/([A-Z])/g, "-$1").toLowerCase()),
            s = s || r.length ? s : r[e]) : t.currentStyle && (s = t.currentStyle[e]),
            ...
            var r = t.vars
              , s = r[i]
              , n = t._listeners[e];
            "function" == typeof s && s.apply(r[i + "Scope"] || r.callbackScope || t, r[i + "Params"] || [t.pointerEvent]),
            n && t.dispatchEvent(e)
        }, oe = function(t, e) {
            var i, r, s, n = $(t);
            return n ? Ce(n, e) : void 0 !== t.left ? (s = xe(e),
            {
                left: t.left - s.x,
                top: t.top - s.y,
                width: t.width,
            ...
            if (!g.createElementNS)
                return a = 0,
                o = !1,
                void 0;
            var t, e, i, r, s = y("div"), n = g.createElementNS("http://www.w3.org/2000/svg", "svg"), u = y("div"), _ = s.style, c = g.body || v;
            g.body && _e && (_.position = u.style.position = "absolute",
            c.appendChild(u),
            u.appendChild(s),
            _.height = "10px",
            r = s.offsetTop,
            ...
            t = n.getScreenCTM(),
            0 === e && 0 === t.e && 0 === t.f && 1 === t.a ? (a = 1,
            o = !0) : (a = e !== t.e ? 1 : 0,
            o = 1 !== t.a),
            c.removeChild(n)
        }, he = "" !== K(T, "perspective"), ue = K(T, "transformOrigin").replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(), _e = K(T, "transform"), ce = _e.replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(), fe = {}, pe = {}, de = window.SVGElement, me = function(t) {
            return !!(de && "function" == typeof t.getBBox && t.getCTM && (!t.parentNode || t.parentNode.getBBox && t.parentNode.getCTM))
        }, ge = (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(navigator.userAgent) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(navigator.userAgent)) && 11 > parseFloat(RegExp.$1), ve = [], ye = [], Te = function(t) {
            ...
            if (We.cacheSVGData !== !1 && t._gsCache && t._gsCache.lastUpdate === e.ticker.frame)
                return t._gsCache;
            var i, r, s, n, h, u, _, c, f, p, d, m, y = t, T = we(t);
            if (T.lastUpdate = e.ticker.frame,
            t.getBBox && !T.isSVGRoot) {
                for (y = t.parentNode,
                i = t.getBBox(); y && "svg" !== (y.nodeName + "").toLowerCase(); )
                    y = y.parentNode;
                return n = Te(y),
            ...
            for (s = T.offsetParent,
            s === g.body && (s = v),
            ye.length = ve.length = 0; y && (h = ne(y, _e, !0),
            "matrix(1, 0, 0, 1, 0, 0)" !== h && "none" !== h && "translate3d(0px, 0px, 0px)" !== h && (ye.push(y),
            ve.push(y.style[_e]),
            y.style[_e] = "none"),
            y !== s); )
                y = y.parentNode;
            for (r = s.getBoundingClientRect(),
            h = t.getScreenCTM(),
            c = t.createSVGPoint(),
            ...
            T.scaleY = (c.y - _.y) / 10,
            void 0 === a && le(),
            T.borderBox && !o && t.getAttribute("width") && (n = te(t) || {},
            f = parseFloat(n.borderLeftWidth) + parseFloat(n.borderRightWidth) || 0,
            p = parseFloat(n.borderTopWidth) + parseFloat(n.borderBottomWidth) || 0,
            ...
            T.offsetTop = i.top - r.top) : (T.offsetLeft = _.x - r.left,
            T.offsetTop = _.y - r.top),
            T.offsetParent = s,
            u = ye.length; --u > -1; )
                ye[u].style[_e] = ve[u];
            return T
            ...
            return ("center" === o || null == o) && (o = "50%"),
            ("center" === a || isNaN(parseFloat(a))) && (a = "50%"),
            t.getBBox && me(t) ? (t._gsTransform || (e.set(t, {
                x: "+=0",
                overwrite: !1
            }),
            ...
            i.y = t._gsTransform.yOrigin - s.y) : (t.getBBox && !t.offsetWidth && -1 !== (a + o).indexOf("%") && (t = t.getBBox(),
            t = {
                offsetWidth: t.width,
                offsetHeight: t.height
            }),
            i.x = -1 !== a.indexOf("%") ? t.offsetWidth * parseFloat(a) / 100 : parseFloat(a),
            i.y = -1 !== o.indexOf("%") ? t.offsetHeight * parseFloat(o) / 100 : parseFloat(o)),
            i
        }, we = function(t) {
            if (We.cacheSVGData !== !1 && t._gsCache && t._gsCache.lastUpdate === e.ticker.frame)
                return t._gsCache;
            var i, r = t._gsCache = t._gsCache || {}, s = te(t), n = t.getBBox && me(t), a = "svg" === (t.nodeName + "").toLowerCase();
            if (r.isSVG = n,
            r.isSVGRoot = a,
            r.borderBox = "border-box" === s.boxSizing,
            r.computedStyle = s,
            a)
                (r.offsetParent = t.offsetParent) || (t.parentNode.insertBefore(T, t),
            ...
            if (t === window || !t || !t.style || !t.parentNode)
                return [1, 0, 0, 1, 0, 0];
            var s, n, o, l, u, _, c, f, p, d, m, y, T, x, w = t._gsCache || we(t), b = t.parentNode, P = b._gsCache || we(b), S = w.computedStyle, k = w.isSVG ? P.offsetParent : b.offsetParent;
            return s = w.isSVG && -1 !== (t.style[_e] + "").indexOf("matrix") ? t.style[_e] : S ? S.getPropertyValue(ce) : t.currentStyle ? t.currentStyle[_e] : "1,0,0,1,0,0",
            t.getBBox && -1 !== (t.getAttribute("transform") + "").indexOf("matrix") && (s = t.getAttribute("transform")),
            s = (s + "").match(/(?:\-|\b)[\d\-\.e]+\b/g) || [1, 0, 0, 1, 0, 0],
            s.length > 6 && (s = [s[0], s[1], s[4], s[5], s[12], s[13]]),
            r ? s[4] = s[5] = 0 : w.isSVG && (u = t._gsTransform) && (u.xOrigin || u.yOrigin) && (s[0] = parseFloat(s[0]),
            s[1] = parseFloat(s[1]),
            s[2] = parseFloat(s[2]),
            s[3] = parseFloat(s[3]),
            s[4] = parseFloat(s[4]) - (u.xOrigin - (u.xOrigin * s[0] + u.yOrigin * s[2])),
            s[5] = parseFloat(s[5]) - (u.yOrigin - (u.xOrigin * s[1] + u.yOrigin * s[3]))),
            e && (void 0 === a && le(),
            ...
            }) : w.isSVGRoot ? (m = parseInt(S.borderTopWidth, 10) || 0,
            ...
            s[3] *= c,
            ge || (e.x += T,
            e.y += x)) : !h && t.offsetParent && (e.x += parseInt(ne(t.offsetParent, "borderLeftWidth"), 10) || 0,
            e.y += parseInt(ne(t.offsetParent, "borderTopWidth"), 10) || 0),
            n = b === v || b === g.body,
            s[4] = Number(s[4]) + e.x + (o.offsetLeft || 0) - i.x - (n ? 0 : b.scrollLeft || 0),
            s[5] = Number(s[5]) + e.y + (o.offsetTop || 0) - i.y - (n ? 0 : b.scrollTop || 0),
            b && "fixed" === ne(t, "position", S) && (s[4] += U(),
            s[5] += j()),
            b && b !== v && k === o.offsetParent && (s[4] -= b.offsetLeft || 0,
            s[5] -= b.offsetTop || 0,
            h || !b.offsetParent || w.isSVG || w.isSVGRoot || (s[4] -= parseInt(ne(b.offsetParent, "borderLeftWidth"), 10) || 0,
            s[5] -= parseInt(ne(b.offsetParent, "borderTopWidth"), 10) || 0))),
            s
        }, Pe = function(t, e) {
            if (!t || t === window || !t.parentNode)
                return [1, 0, 0, 1, 0, 0];
            for (var i, r, s, n, a, o, l, h, u = xe(t, fe), _ = xe(t.parentNode, pe), c = be(t, u, _); (t = t.parentNode) && t.parentNode && t !== v; )
                u = _,
            ...
            if (!(t = $(t)))
                return null;
            e = $(e);
            var r, s, n, a, o, l, h, u, _, c, f, p, d, m, y, T, x, w, b, P, S, C, R = t.getBBox && me(t);
            if (t === window)
                a = j(),
                s = U(),
                n = s + (v.clientWidth || t.innerWidth || g.body.clientWidth || 0),
                o = a + ((t.innerHeight || 0) - 20 < v.clientHeight ? v.clientHeight : t.innerHeight || g.body.clientHeight || 0);
            else {
                ...
                R ? (p = t.getBBox(),
                d = p.width,
                m = p.height) : t.offsetWidth ? (d = t.offsetWidth,
                m = t.offsetHeight) : (S = te(t),
                d = parseFloat(S.width),
                m = parseFloat(S.height)),
                n = s + d,
                o = a + m,
                "svg" !== t.nodeName.toLowerCase() || k || (y = Te(t),
                C = y.computedStyle || {},
                ...
                s -= T / y.scaleX - b,
                a -= x / y.scaleY - P,
                S && (n += (parseFloat(C.borderRightWidth) + T) / y.scaleX,
            ...
            for (e = 0; n > e; e++)
                ...
                Re(i))
                    ...
                    s.push(i);
            return s
        }, Ae = "ontouchstart"in v && "orientation"in window, De = function(t) {
            for (var e = t.split(","), i = (void 0 !== T.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel" : void 0 !== T.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : t).split(","), r = {}, s = 8; --s > -1; )
                r[e[s]] = i[s],
                r[i[s]] = e[s];
            return r
        }("touchstart,touchmove,touchend,touchcancel"), Me = function(t, e, i, r) {
            t.addEventListener ? t.addEventListener(De[e] || e, i, r) : t.attachEvent && t.attachEvent("on" + e, i)
        }, Le = function(t, e, i) {
            ...
            s = t.touches && t.touches.length > M,
            Le(t.target, "touchend", Ee)
        }, Ie = function(t) {
            s = t.touches && t.touches.length > M,
            Me(t.target, "touchend", Ee)
        }, ze = function(t, e, i, r, s, n) {
            var a, o, l, h = {};
            if (e)
                if (1 !== s && e instanceof Array) {
                    ...
                    h.end = "function" == typeof e ? function(i) {
                        return e.call(t, i) * s
                    }
                    : e;
            return (i || 0 === i) && (h.max = i),
            (r || 0 === r) && (h.min = r),
            n && (h.velocity = 0),
            h
        }, Fe = function(t) {
            var e;
            return t && t.getAttribute && "BODY" !== t.nodeName ? "true" === (e = t.getAttribute("data-clickable")) || "false" !== e && (t.onclick || D.test(t.nodeName + "") || "true" === t.getAttribute("contentEditable")) ? !0 : Fe(t.parentNode) : !1
        }, Xe = function(t, e) {
            ...
            var t, e = g.createElement("div"), i = g.createElement("div"), r = i.style, s = g.body || T;
            return r.display = "inline-block",
            r.position = "relative",
            ...
            t = $(t),
            i = i || {};
            var r, s, n, a, o, l, h = g.createElement("div"), _ = h.style, c = t.firstChild, f = 0, p = 0, d = t.scrollTop, m = t.scrollLeft, v = t.scrollWidth, y = t.scrollHeight, T = 0, x = 0, w = 0;
            he && i.force3D !== !1 ? (o = "translate3d(",
            l = "px,0px)") : _e && (o = "translate(",
            l = "px)"),
            ...
            this.left = function(r, s) {
                ...
                var n = t.scrollLeft - m
                  , a = p;
                return (n > 2 || -2 > n) && !s ? (m = t.scrollLeft,
                ...
                r = 0) : r > x ? (p = 0 | r - x,
                r = x) : p = 0,
                (p || a) && (o ? this._suspendTransforms || (_[_e] = o + -p + "px," + -f + l) : _.left = -p + "px",
            ...
            this.top = function(r, s) {
                ...
                var n = t.scrollTop - d
                  , a = f;
                return (n > 2 || -2 > n) && !s ? (d = t.scrollTop,
                e.killTweensOf(this, !0, {
                    top: 1,
                    scrollTop: 1
                }),
                ...
                r = 0) : r > w ? (f = 0 | r - w,
                r = w) : f = 0,
                (f || a) && (o ? this._suspendTransforms || (_[_e] = o + -p + "px," + -f + l) : _.top = -f + "px"),
                t.scrollTop = 0 | r,
                d = t.scrollTop,
                void 0)
            }
            ...
            this.calibrate = function(e) {
                ...
                d = t.scrollTop,
                m = t.scrollLeft,
                (!o || t.clientHeight !== s || h.offsetHeight !== n || v !== t.scrollWidth || y !== t.scrollHeight || e) && ((f || p) && (i = this.left(),
                a = this.top(),
                ...
                T && (T += ne(t, "paddingLeft") + (u ? ne(t, "paddingRight") : 0))),
            ...
            this.edgeResistance = isNaN(a.edgeResistance) ? 1 : parseFloat(a.edgeResistance) || 0,
            this.lockAxis = a.lockAxis,
            this.autoScroll = a.autoScroll || 0,
            this.lockedAxis = null,
            this.allowEventDefault = !!a.allowEventDefault;
            var o, l, h, u, m, y, T, w, R, D, E, F, Y, j, U, H, K, te, ee, ie, re, se, le, he, ue, _e, ce, fe, pe, de, me, ge = (a.type || (k ? "top,left" : "x,y")).toLowerCase(), ve = -1 !== ge.indexOf("x") || -1 !== ge.indexOf("y"), ye = -1 !== ge.indexOf("rotation"), Te = ye ? "rotation" : ve ? "x" : "left", xe = ve ? "y" : "top", we = -1 !== ge.indexOf("x") || -1 !== ge.indexOf("left") || "scroll" === ge, be = -1 !== ge.indexOf("y") || -1 !== ge.indexOf("top") || "scroll" === ge, ke = a.minimumMovement || 2, Ce = this, Re = z(a.trigger || a.handle || r), Oe = {}, Ee = 0, Be = !1, je = a.clickableTest || Fe, Ue = function(t) {
                if (Ce.autoScroll && Ce.isDragging && (te || Be)) {
                    var e, i, s, n, a, o, h, u, _ = r, c = 15 * Ce.autoScroll;
                    for (Be = !1,
                    I.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != v.scrollTop ? v.scrollTop : g.body.scrollTop,
                    I.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != v.scrollLeft ? v.scrollLeft : g.body.scrollLeft,
                    n = Ce.pointerX - I.scrollLeft,
                    a = Ce.pointerY - I.scrollTop; _ && !i; )
                        i = q(_.parentNode),
                        e = i ? I : _.parentNode,
                        s = i ? {
                        ...
                        o = h = 0,
                        be && (a > s.bottom - 40 && (u = e._gsMaxScrollY - e.scrollTop) ? (Be = !0,
                        h = Math.min(u, 0 | c * (1 - Math.max(0, s.bottom - a) / 40))) : s.top + 40 > a && e.scrollTop && (Be = !0,
                        h = -Math.min(e.scrollTop, 0 | c * (1 - Math.max(0, a - s.top) / 40))),
                        h && (e.scrollTop += h)),
                        we && (n > s.right - 40 && (u = e._gsMaxScrollX - e.scrollLeft) ? (Be = !0,
                        o = Math.min(u, 0 | c * (1 - Math.max(0, s.right - n) / 40))) : s.left + 40 > n && e.scrollLeft && (Be = !0,
                        o = -Math.min(e.scrollLeft, 0 | c * (1 - Math.max(0, n - s.left) / 40))),
                        o && (e.scrollLeft += o)),
                        i && (o || h) && (window.scrollTo(e.scrollLeft, e.scrollTop),
                        ri(Ce.pointerX + o, Ce.pointerY + h)),
                        _ = e
                }
                if (te) {
                    var f = Ce.x
                    ...
                    d > f && f > -d && (f = 0),
                    d > p && p > -d && (p = 0),
                    ye ? (pe.data.rotation = Ce.rotation = f,
                    pe.setRatio(1)) : l ? (be && l.top(p),
                    we && l.left(f)) : ve ? (be && (pe.data.y = p),
                    we && (pe.data.x = f),
                    pe.setRatio(1)) : (be && (r.style.top = p + "px"),
                    we && (r.style.left = f + "px")),
                    w && !t && ae(Ce, "drag", "onDrag")
                }
                te = !1
            }, Ge = function(t, i) {
                var s;
                r._gsTransform || !ve && !ye || e.set(r, {
                    x: "+=0",
                    overwrite: !1
                }),
                ve ? (Ce.y = r._gsTransform.y,
                Ce.x = r._gsTransform.x) : ye ? Ce.x = Ce.rotation = r._gsTransform.rotation : l ? (Ce.y = l.top(),
                Ce.x = l.left()) : (Ce.y = parseInt(r.style.top, 10) || 0,
                Ce.x = parseInt(r.style.left, 10) || 0),
                !ie && !re || i || (ie && (s = ie(Ce.x),
                s !== Ce.x && (Ce.x = s,
                ye && (Ce.rotation = s),
                te = !0)),
                re && (s = re(Ce.y),
                ...
                te = !0)),
                te && Ue(!0)),
                t || ae(Ce, "throwupdate", "onThrowUpdate")
            }, qe = function() {
                var t, e, i, s;
                T = !1,
                l ? (l.calibrate(),
                Ce.minX = D = -l.maxScrollLeft(),
                Ce.minY = F = -l.maxScrollTop(),
                Ce.maxX = R = Ce.maxY = E = 0,
                T = !0) : a.bounds && (t = oe(a.bounds, r.parentNode),
                ye ? (Ce.minX = D = t.left,
                Ce.maxX = R = t.left + t.width,
                Ce.minY = F = Ce.maxY = E = 0) : void 0 !== a.bounds.maxX || void 0 !== a.bounds.maxY ? (t = a.bounds,
                Ce.minX = D = t.minX,
                Ce.minY = F = t.minY,
                Ce.maxX = R = t.maxX,
                Ce.maxY = E = t.maxY) : (e = oe(r, r.parentNode),
                Ce.minX = D = ne(r, Te) + t.left - e.left,
                Ce.minY = F = ne(r, xe) + t.top - e.top,
                Ce.maxX = R = D + (t.width - e.width),
                Ce.maxY = E = F + (t.height - e.height)),
                D > R && (Ce.minX = R,
                Ce.maxX = R = D,
                D = Ce.minX),
                F > E && (Ce.minY = E,
                ...
                Ce.maxRotation = R),
                T = !0),
                a.liveSnap && (i = a.liveSnap === !0 ? a.snap || {} : a.liveSnap,
                s = i instanceof Array || "function" == typeof i,
                ye ? (ie = ti(s ? i : i.rotation, D, R, 1),
                re = null) : (we && (ie = ti(s ? i : i.x || i.left || i.scrollLeft, D, R, l ? -1 : 1)),
                be && (re = ti(s ? i : i.y || i.top || i.scrollTop, F, E, l ? -1 : 1))))
            }, He = function() {
                Ce.isThrowing = !1,
                ae(Ce, "throwcomplete", "onThrowComplete")
            }, Qe = function() {
                Ce.isThrowing = !1
            }, Ze = function(t, e) {
                var i, s, o, h;
                ...
                s = i instanceof Array || "function" == typeof i,
                t = {
                    resistance: (a.throwResistance || a.resistance || 1e3) / (ye ? 10 : 1)
                },
                ye ? t.rotation = ze(Ce, s ? i : i.rotation, R, D, 1, e) : (we && (t[Te] = ze(Ce, s ? i : i.x || i.left || i.scrollLeft, R, D, l ? -1 : 1, e || "x" === Ce.lockedAxis)),
                be && (t[xe] = ze(Ce, s ? i : i.y || i.top || i.scrollTop, E, F, l ? -1 : 1, e || "y" === Ce.lockedAxis)))),
                Ce.isThrowing = !0,
                h = isNaN(a.overshootTolerance) ? 1 === a.edgeResistance ? 0 : 1 - Ce.edgeResistance + .2 : a.overshootTolerance,
                Ce.tween = o = n.to(l || r, {
                    throwProps: t,
                    ease: a.ease || d.Power3.easeOut,
                    onComplete: He,
                    onOverwrite: Qe,
                    onUpdate: a.fastMode ? ae : Ge,
                    onUpdateParams: a.fastMode ? [Ce, "onthrowupdate", "onThrowUpdate"] : x
                }, isNaN(a.maxDuration) ? 2 : a.maxDuration, isNaN(a.minDuration) ? 0 === h ? 0 : .5 : a.minDuration, h),
                a.fastMode || (l && (l._suspendTransforms = !0),
                o.render(o.duration(), !0, !0),
                Ge(!0, !0),
                Ce.endX = Ce.x,
                Ce.endY = Ce.y,
                ye && (Ce.endRotation = Ce.x),
                o.play(0),
                Ge(!0, !0),
                l && (l._suspendTransforms = !1))) : T && Ce.applyBounds()
            }, $e = function() {
                he = Pe(r.parentNode, !0),
                he[1] || he[2] || 1 != he[0] || 1 != he[3] || 0 != he[4] || 0 != he[5] || (he = null)
            }, Ke = function() {
                var t = 1 - Ce.edgeResistance;
                $e(),
                l ? (qe(),
                y = l.top(),
                m = l.left()) : (Je() ? (Ge(!0, !0),
                ...
                Ge(!0, !0),
                m = Ce.x,
                y = Ce.y = Math.atan2(K.y - u, h - K.x) * b) : (ce = r.parentNode ? r.parentNode.scrollTop || 0 : 0,
                fe = r.parentNode ? r.parentNode.scrollLeft || 0 : 0,
                y = ne(r, xe),
                m = ne(r, Te))),
                T && t && (m > R ? m = R + (m - R) / t : D > m && (m = D - (D - m) / t),
                ye || (y > E ? y = E + (y - E) / t : F > y && (y = F - (F - y) / t)))
            }, Je = function() {
                return Ce.tween && Ce.tween.isActive()
            }, ti = function(t, e, i, r) {
                return "function" == typeof t ? function(s) {
                    var n = Ce.isPressed ? 1 - Ce.edgeResistance : 1;
                    return t.call(Ce, s > i ? i + (s - i) * n : e > s ? e + (s - e) * n : s) * r
                }
                ...
                var i, s;
                if (o && !Ce.isPressed && t && !("mousedown" === t.type && 30 > S() - _e && De[Ce.pointerEvent.type])) {
                    if (ue = Je(),
                    Ce.pointerEvent = t,
                    De[t.type] ? (le = -1 !== t.type.indexOf("touch") ? t.currentTarget : g,
                    Me(le, "touchend", si),
                    Me(le, "touchmove", ii),
                    Me(le, "touchcancel", si),
                    Me(g, "touchstart", Ie)) : (le = null,
                    Me(g, "mousemove", ii)),
                    me = null,
                    Me(g, "mouseup", si),
                    t && t.target && Me(t.target, "mouseup", si),
                    se = je.call(Ce, t.target) && !a.dragClickables)
                        return Me(t.target, "change", si),
                        ae(Ce, "press", "onPress"),
                        Xe(Re, !0),
                        void 0;
                    if (de = !le || we === be || l || Ce.vars.allowNativeTouchScrolling === !1 ? !1 : we ? "y" : "x",
                    k ? t = Z(t, !0) : de || Ce.allowEventDefault || (t.preventDefault(),
                    t.preventManipulation && t.preventManipulation()),
                    t.changedTouches ? (t = U = t.changedTouches[0],
                    H = t.identifier) : t.pointerId ? H = t.pointerId : U = H = null,
                    M++,
                    X(Ue),
                    u = Ce.pointerY = t.pageY,
                    h = Ce.pointerX = t.pageX,
                    (de || Ce.autoScroll) && Q(r.parentNode),
                    !Ce.autoScroll || ye || l || !r.parentNode || r.getBBox || !r.parentNode._gsMaxScrollX || C.parentNode || (C.style.width = r.parentNode.scrollWidth + "px",
                    r.parentNode.appendChild(C)),
                    Ke(),
                    he && (i = h * he[0] + u * he[2] + he[4],
                    u = h * he[1] + u * he[3] + he[5],
                    h = i),
                    Ce.tween && Ce.tween.kill(),
                    Ce.isThrowing = !1,
                    e.killTweensOf(l || r, !0, Oe),
                    l && e.killTweensOf(r, !0, {
                        scrollTo: 1
                    }),
                    Ce.tween = Ce.lockedAxis = null,
                    (a.zIndexBoost || !ye && !l && a.zIndexBoost !== !1) && (r.style.zIndex = We.zIndex++),
                    Ce.isPressed = !0,
                    w = !(!a.onDrag && !Ce._listeners.drag),
                    !ye)
                        for (s = Re.length; --s > -1; )
                            J(Re[s], "cursor", a.cursor || "move");
                    ae(Ce, "press", "onPress")
                }
            }, ii = function(t) {
                var e, i, r, n, a = t;
                if (o && !s && Ce.isPressed && t) {
                    if (Ce.pointerEvent = t,
                    e = t.changedTouches) {
                        if (t = e[0],
                        t !== U && t.identifier !== H) {
                            for (n = e.length; --n > -1 && (t = e[n]).identifier !== H; )
                                ;
                            if (0 > n)
                                return
                        }
                    ...
                    if (k)
                        ...
                        if (le && de && !me && (i = t.pageX,
                        r = t.pageY,
                        he && (n = i * he[0] + r * he[2] + he[4],
                        r = i * he[1] + r * he[3] + he[5],
                        i = n),
                        me = Math.abs(i - h) > Math.abs(r - u) && we ? "x" : "y",
                        Ce.vars.lockAxisOnTouchScroll !== !1 && (Ce.lockedAxis = "x" === me ? "y" : "x",
                        "function" == typeof Ce.vars.onLockAxis && Ce.vars.onLockAxis.call(Ce, a)),
                        L && de === me))
                            return si(a),
                            void 0;
                        Ce.allowEventDefault || de && (!me || de === me) || a.cancelable === !1 || (a.preventDefault(),
                ...
                var i, r, s, n, a, o, l = 1 - Ce.dragResistance, _ = 1 - Ce.edgeResistance;
                Ce.pointerX = t,
                Ce.pointerY = e,
                ye ? (n = Math.atan2(K.y - e, t - K.x) * b,
                a = Ce.y - n,
                Ce.y = n,
                a > 180 ? y -= 360 : -180 > a && (y += 360),
                s = m + (y - n) * l) : (he && (o = t * he[0] + e * he[2] + he[4],
                ...
                ke > r && r > -ke && (r = 0),
                ke > i && i > -ke && (i = 0),
                (Ce.lockAxis || Ce.lockedAxis) && (i || r) && (o = Ce.lockedAxis,
                o || (Ce.lockedAxis = o = we && Math.abs(i) > Math.abs(r) ? "y" : be ? "x" : null,
                o && "function" == typeof Ce.vars.onLockAxis && Ce.vars.onLockAxis.call(Ce, Ce.pointerEvent)),
                "y" === o ? r = 0 : "x" === o && (i = 0)),
                s = m + i * l,
                n = y + r * l),
                ie || re ? (ie && (s = ie(s)),
                re && (n = re(n))) : T && (s > R ? s = R + (s - R) * _ : D > s && (s = D + (s - D) * _),
                ye || (n > E ? n = E + (n - E) * _ : F > n && (n = F + (n - F) * _))),
                ye || (s = Math.round(s),
                n = Math.round(n)),
                (Ce.x !== s || Ce.y !== n && !ye) && (ye ? Ce.endRotation = Ce.x = Ce.endX = s : (be && (Ce.y = Ce.endY = n),
                we && (Ce.x = Ce.endX = s)),
                te = !0,
                Ce.isDragging || (Ce.isDragging = !0,
                ae(Ce, "dragstart", "onDragStart")))
            }, si = function(t, e) {
                if (o && Ce.isPressed && (!t || null == H || e || !(t.pointerId && t.pointerId !== H || t.changedTouches && !Ne(t.changedTouches, H)))) {
                    Ce.isPressed = !1;
                    var i, s, n, l, h = t, u = Ce.isDragging;
                    if (le ? (Le(le, "touchend", si),
                    Le(le, "touchmove", ii),
                    Le(le, "touchcancel", si),
                    Le(g, "touchstart", Ie)) : Le(g, "mousemove", ii),
                    Le(g, "mouseup", si),
                    t && t.target && Le(t.target, "mouseup", si),
                    te = !1,
                    C.parentNode && C.parentNode.removeChild(C),
                    se)
                        return t && Le(t.target, "change", si),
                        Xe(Re, !1),
                        ae(Ce, "release", "onRelease"),
                        ae(Ce, "click", "onClick"),
                        se = !1,
                        void 0;
                    if (B(Ue),
                    ...
                    return h && !u ? (ue && (a.snap || a.bounds) && Ze(a.throwProps),
                    ae(Ce, "release", "onRelease"),
                    L && "touchmove" === h.type || (ae(Ce, "click", "onClick"),
                    l = h.target || h.srcElement || r,
                    l.click ? l.click() : g.createEvent && (n = g.createEvent("MouseEvents"),
                    n.initEvent("click", !0, !0),
                    l.dispatchEvent(n)),
                    _e = S())) : (Ze(a.throwProps),
                    k || Ce.allowEventDefault || !h || !a.dragClickables && je.call(Ce, h.target) || !u || de && (!me || de !== me) || h.cancelable === !1 || (h.preventDefault(),
                    h.preventManipulation && h.preventManipulation()),
                    ae(Ce, "release", "onRelease")),
                    u && ae(Ce, "dragend", "onDragEnd"),
                    !0
                }
            }, ni = function(t) {
                if (t && Ce.isDragging) {
                    ...
                    e._gsScrollX += i,
                    e._gsScrollY += s,
                    ri(Ce.pointerX, Ce.pointerY))
                }
            }, ai = function(t) {
                var e = S()
                  , i = 40 > e - _e
                  , r = 40 > e - Ee;
                (Ce.isPressed || r || i) && (t.preventDefault ? (t.preventDefault(),
                (i || r && Ce.vars.suppressClickOnDrag !== !1) && t.stopImmediatePropagation()) : t.returnValue = !1,
                t.preventManipulation && t.preventManipulation())
            };
            ...
            this.timeSinceDrag = function() {
                return Ce.isDragging ? 0 : (S() - Ee) / 1e3
            }
            ,
            this.hitTest = function(t, e) {
                return We.hitTest(Ce.target, t, e)
            }
            ,
            this.getDirection = function(t, e) {
                var i, r, s, a, o, l, h = "velocity" === t && n ? t : "object" != typeof t || ye ? "start" : "element";
                return "element" === h && (o = Ve(Ce.target),
                l = Ve(t)),
                i = "start" === h ? Ce.x - m : "velocity" === h ? n.getVelocity(this.target, Te) : o.left + o.width / 2 - (l.left + l.width / 2),
                ye ? 0 > i ? "counter-clockwise" : "clockwise" : (e = e || 2,
                r = "start" === h ? Ce.y - y : "velocity" === h ? n.getVelocity(this.target, xe) : o.top + o.height / 2 - (l.top + l.height / 2),
                s = Math.abs(i / r),
            ...
            this.applyBounds = function(t) {
                var e, i;
                return t && a.bounds !== t ? (a.bounds = t,
                Ce.update(!0)) : (Ge(!0),
                qe(),
                T && (e = Ce.x,
                i = Ce.y,
                T && (e > R ? e = R : D > e && (e = D),
                i > E ? i = E : F > i && (i = F)),
                (Ce.x !== e || Ce.y !== i) && (Ce.x = Ce.endX = e,
                ye ? Ce.endRotation = e : Ce.y = Ce.endY = i,
                te = !0,
                Ue())),
                Ce)
            }
            ...
            this.update = function(t) {
                var e = Ce.x
                  , i = Ce.y;
                return $e(),
                t ? Ce.applyBounds() : (te && Ue(),
                Ge(!0)),
                Ce.isPressed && (we && Math.abs(e - Ce.x) > .01 || be && Math.abs(i - Ce.y) > .01 && !ye) && Ke(),
                Ce
            }
            ,
            this.enable = function(t) {
                ...
                if ("soft" !== t) {
                    for (h = Re.length; --h > -1; )
                        ...
                        Me(u, "touchstart", ei),
                        Me(u, "click", ai, !0),
                        ye || J(u, "cursor", a.cursor || "move"),
                        J(u, "touchCallout", "none"),
                        J(u, "touchAction", we === be || l ? "none" : we ? "pan-y" : "pan-x");
                    Xe(Re, !1)
                }
                return V(Ce.target, ni),
                o = !0,
                n && "soft" !== t && n.track(l || r, ve ? "x,y" : ye ? "rotation" : "top,left"),
                l && l.enable(),
                r._gsDragID = s = "d" + A++,
                O[s] = this,
            ...
            this.disable = function(t) {
                ...
                return G(r, ni),
                o = !1,
                n && "soft" !== t && n.untrack(l || r, ve ? "x,y" : ye ? "rotation" : "top,left"),
                l && l.disable(),
                B(Ue),
                this.isDragging = this.isPressed = se = !1,
                s && ae(this, "dragend", "onDragEnd"),
                Ce
            }
            ,
            this.enabled = function(t, e) {
                return arguments.length ? t ? this.enable(e) : this.disable(e) : o
            }
            ,
            this.kill = function() {
                return Ce.isThrowing = !1,
                e.killTweensOf(l || r, !0, Oe),
                Ce.disable(),
            ...
            ,
            -1 !== ge.indexOf("scroll") && (l = this.scrollProxy = new Ye(r,W({
                onKill: function() {
                    Ce.isPressed && si(null)
                }
            }, a)),
            r.style.overflowY = be && !Ae ? "auto" : "hidden",
            r.style.overflowX = we && !Ae ? "auto" : "hidden",
            r = l.content),
            a.force3D !== !1 && e.set(r, {
                force3D: !0
            }),
            ye ? Oe.rotation = 1 : (we && (Oe[Te] = 1),
            be && (Oe[xe] = 1)),
            ye ? (Y = p,
            j = Y.css,
            Y.overwrite = !1) : ve && (Y = we && be ? _ : we ? c : f,
            j = Y.css,
            Y.overwrite = !1),
            this.enable()
        ...
        Me(g, "contextmenu", function() {
            var t;
            for (t in O)
                O[t].isPressed && O[t].endDrag()
        }),
        We.create = function(t, i) {
            "string" == typeof t && (t = e.selector(t));
            for (var r = Re(t) ? Oe(t) : [t], s = r.length; --s > -1; )
                r[s] = new We(r[s],i);
            return r
        }
        ,
        ...
        var Ue = {}
          , Ve = function(t, e) {
            if (t === window)
                return Ue.left = Ue.top = 0,
                Ue.width = Ue.right = v.clientWidth || t.innerWidth || g.body.clientWidth || 0,
                Ue.height = Ue.bottom = (t.innerHeight || 0) - 20 < v.clientHeight ? v.clientHeight : t.innerHeight || g.body.clientHeight || 0,
                Ue;
            var i = t.pageX !== e ? {
                left: t.pageX,
                top: t.pageY,
                right: t.pageX + 1,
                bottom: t.pageY + 1
            } : t.nodeType || t.left === e || t.top === e ? $(t).getBoundingClientRect() : t;
        ...
        return We.hitTest = function(t, e, i) {
            if (t === e)
                return !1;
            var r, s, n, a = Ve(t), o = Ve(e), l = o.left > a.right || o.right < a.left || o.top > a.bottom || o.bottom < a.top;
            return l || !i ? !l : (n = -1 !== (i + "").indexOf("%"),
            i = parseFloat(i) || 0,
            r = {
            ...
            0 > r.width || 0 > r.height ? !1 : n ? (i *= .01,
            s = r.width * r.height,
            s >= a.width * a.height * i || s >= o.width * o.height * i) : r.width > i && r.height > i)
        }
        ,
